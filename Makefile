...
LDFLAGS += -L/Users/sean/video-store-review/Fmpeg/n6.1/darwin-arm64/build/lib
CGO_LDFLAGS := "-L$(FFMPEG_BUILD)/lib -lavcodec -lavutil -lavformat /opt/homebrew/Cellar/x264/r3108/lib/libx264.a -lz -liconv"
